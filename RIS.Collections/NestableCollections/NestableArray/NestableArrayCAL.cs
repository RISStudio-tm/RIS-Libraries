...
namespace RIS.Collections.NestableCollections
{
    public class NestableArrayCAL<T> : INestableCollection<T>, ICollection, IEnumerable<T>, IEnumerable
    {
        ...
        {
            ValuesCollection.GetRef(index) = value;
        }
        public void Set(int chunkIndex, uint valueIndex, NestedElement<T> value)
        {
            ValuesCollection.GetRef(chunkIndex, valueIndex) = value;
        }
        ...
        {
            NestableCollectionHelper.FromStringRepresent<T, NestableArrayCAL<T>>(represent, this);
        }
