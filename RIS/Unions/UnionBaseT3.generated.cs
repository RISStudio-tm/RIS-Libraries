...
{
    public class UnionBase<T0, T1, T2, T3> : IUnion
    {
        readonly T0 _value0;
        readonly T1 _value1;
        readonly T2 _value2;
        ...
        protected UnionBase(Union<T0, T1, T2, T3> input)
        {
            _index = input.Index;
            switch (_index)
            {
        ...
        bool Equals(UnionBase<T0, T1, T2, T3> other) =>
            _index == other._index &&
            _index switch
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is UnionBase<T0, T1, T2, T3> o && Equals(o);
        }
