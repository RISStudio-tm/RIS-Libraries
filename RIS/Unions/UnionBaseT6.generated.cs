...
{
    public class UnionBase<T0, T1, T2, T3, T4, T5, T6> : IUnion
    {
        readonly T0 _value0;
        readonly T1 _value1;
        readonly T2 _value2;
        ...
        protected UnionBase(Union<T0, T1, T2, T3, T4, T5, T6> input)
        {
            _index = input.Index;
            switch (_index)
            {
        ...
        bool Equals(UnionBase<T0, T1, T2, T3, T4, T5, T6> other) =>
            _index == other._index &&
            _index switch
            {
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is UnionBase<T0, T1, T2, T3, T4, T5, T6> o && Equals(o);
        }
