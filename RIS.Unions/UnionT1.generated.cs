...
{
    public readonly struct Union<T0, T1> : IUnion
    {
        readonly T0 _value0;
        readonly T1 _value1;
        readonly int _index;

        Union(int index, T0 value0 = default, T1 value1 = default)
        {
            _index = index;
            _value0 = value0;
            _value1 = value1;
        ...
        public static implicit operator Union<T0, T1>(T0 t) => new Union<T0, T1>(0, value0: t);
        public static implicit operator Union<T0, T1>(T1 t) => new Union<T0, T1>(1, value1: t);
        ...
        public static Union<T0, T1> FromT0(T0 input) => input;
        public static Union<T0, T1> FromT1(T1 input) => input;
        ...
        public override bool Equals(object obj)
        {
            ...
            return obj is Union<T0, T1> o && Equals(o);
        }
