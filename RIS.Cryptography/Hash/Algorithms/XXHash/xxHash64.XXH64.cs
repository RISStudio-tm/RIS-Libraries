...
namespace RIS.Cryptography.Hash.Algorithms
{
    ...
    public static partial class XXHash64
    {
        ...
        private static unsafe ulong XXH64(
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static ulong XXH64_round(
            ulong acc, ulong input)
        {
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static ulong XXH64_mergeRound(
            ulong acc, ulong input)
        {
            input = XXH64_round(0, input);
            acc ^= input;
        ...
        [MethodImpl(MethodImplOptions.AggressiveInlining)]
        private static unsafe ulong XXH64_finalize(
            ulong hash, byte* ptr, int len)
        {
            len &= 31;
