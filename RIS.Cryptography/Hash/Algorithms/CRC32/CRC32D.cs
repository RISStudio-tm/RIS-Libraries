...
{
    public sealed class CRC32D : HashAlgorithm
    {
        private const uint Polynomial = 0xD419CC15;
        private static readonly uint[] Table = new uint[16 * 256];
        private uint CurrentInitial { get; set; }

        public new static CRC32D Create()
        {
            return new CRC32D();
        }
        public new static CRC32D Create(string hashName)
        {
            return new CRC32D();
        }
