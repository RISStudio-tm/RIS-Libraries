...
namespace RIS.Cryptography.Hash.Methods
{
    public sealed class XXHash3b64 : IRawHashMethod
    {
        ...
        {
            return BytesUtils.ToBytesBE(Algorithms.XXHash3.ComputeHash(plainText, Seed));
        }
        public byte[] GetHashBytes(byte[] data)
        {
            return BytesUtils.ToBytesBE(Algorithms.XXHash3.ComputeHash(data, data.Length, Seed));
        }
