...
{
    public sealed class SHA512 : IRawHashMethod
    {
        private System.Security.Cryptography.SHA512 SHAService { get; }

        public bool Initialized { get; }

        public SHA512()
        {
            SHAService = System.Security.Cryptography.SHA512.Create();
