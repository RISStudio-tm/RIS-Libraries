...
namespace RIS.Connection.MySQL.Requests
{
    ...
    /// </summary>
    public sealed class StoredProcedureNotRetRequest : IQueryRequest<string[]>
    {
        /// <summary>
        ...
        private StoredProcedureNotRetRequest(IRequestEngine engine, StoredProcedureNotRetRequest request)
        ...
        /// <summary>
        ///     Инициализирует новый экземпляр класса <see cref="RIS.Connection.MySQL.Requests.StoredProcedureNotRetRequest"/>.
        /// </summary>
        /// <param name="engine">
        ...
        /// </param>
        public StoredProcedureNotRetRequest(IRequestEngine engine, string name,
        ...
        ///     Создаёт копию запроса.
        /// </summary>
        public StoredProcedureNotRetRequest Copy()
        {
            return Copy(Engine);
        }
        /// <summary>
        ...
        ///     Экземпляр сервиса <see cref="RIS.Connection.MySQL.IRequestEngine"/>, с помощью которого будет выполняться запрос.
        /// </param>
        public StoredProcedureNotRetRequest Copy(IRequestEngine engine)
        {
            return new StoredProcedureNotRetRequest(engine, this);
        }
        ...
        public static string[] Execute(IRequestEngine engine, string name,
            ...
            TimeSpan timeout, IsolationLevel isolationLevel = IsolationLevel.ReadCommitted)
        {
            return new StoredProcedureNotRetRequest(engine, name, inParameters, outParametersNames,
